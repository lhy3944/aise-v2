  ...
  return (
    ...
    >
      ...
      >
        <Sun
          className={cn(
            'text-muted-foreground absolute size-3 transition-all duration-300',
            effectiveChecked ? 'scale-0 rotate-90 opacity-0' : 'scale-100 rotate-0 opacity-100',
          )}
        />
        <Moon
          fill='currentColor'
          className={cn(
            ...
            effectiveChecked ? 'scale-100 rotate-0 opacity-100' : 'scale-0 -rotate-90 opacity-0',
          )}
        />
      </SwitchPrimitive.Thumb>
    </SwitchPrimitive.Root>
