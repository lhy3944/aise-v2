...
export function RequirementInput({ onAdd, onRefine, isRefining = false }: RequirementInputProps) {
  ...
  return (
    <div className='border-line-primary rounded-lg border p-4'>
      ...
      <div className='flex items-center justify-between'>
        <span className='text-fg-muted text-xs'>자연어로 입력하면 AI가 정제해 드립니다.</span>
