...
import { Box, Component, GitBranch, Grip, Shield, ShieldCheck, Workflow } from 'lucide-react';
import { AnimatedGridMenu, type GridMenuItem } from '@/components/overlay/AnimatedGridMenu';
